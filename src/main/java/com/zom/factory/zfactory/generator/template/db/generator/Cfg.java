...
public class Cfg {
    ...
    public static String output_dir_base = base_dir + File.separator + project_name + File.separator + "template-output" + File.separator;
    ...
    public static String template_dir_name = base_dir + File.separator + project_name + File.separator + "template";
    ...
    public static String jdbc_pswd = "vfr47ujm"; // 密码
